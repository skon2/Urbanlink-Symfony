 ...
 */
class getAbonnementReservationRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\AbonnementReservationRepository' shared autowired service.
     *
     * @return \App\Repository\AbonnementReservationRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'AbonnementReservationRepository.php';

        return $container->privates['App\\Repository\\AbonnementReservationRepository'] = new \App\Repository\AbonnementReservationRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
