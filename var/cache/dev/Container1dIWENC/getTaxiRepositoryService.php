 ...
 */
class getTaxiRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TaxiRepository' shared autowired service.
     *
     * @return \App\Repository\TaxiRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TaxiRepository.php';

        return $container->privates['App\\Repository\\TaxiRepository'] = new \App\Repository\TaxiRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
