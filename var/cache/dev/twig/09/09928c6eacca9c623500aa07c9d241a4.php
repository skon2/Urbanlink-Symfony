...
class __TwigTemplate_b3e92024e486b3fc5db28a5fa194c7ed extends Template
{
    ...
    <div class=\"row\">
        ...
        <div class=\"span6\">
            ";
        // line 16
        if ((($tmp =  !Twig\Extension\CoreExtension::testEmpty(CoreExtension::getAttribute($this->env, $this->source, (isset($context["userInformation"]) || array_key_exists("userInformation", $context) ? $context["userInformation"] : (function () { throw new RuntimeError('Variable "userInformation" does not exist.', 16, $this->source); })()), "profilePicture", [], "any", false, false, false, 16))) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 17
            yield "                <img src=\"";
    ...
    <div class=\"row\">
        ...
        <div class=\"span6\">
            {% if userInformation.profilePicture is not empty %}
                <img src=\"{{ userInformation.profilePicture }}\"  alt=\"\" />
            {% endif %}
        </div>
    </div>

{% endblock hwi_oauth_content %}
", "@HWIOAuth/Connect/registration.html.twig", "C:\\Users\\skonb\\Desktop\\UrbanLink_Symfony-Production\\vendor\\hwi\\oauth-bundle\\src\\Resources\\views\\Connect\\registration.html.twig");
    }
}
