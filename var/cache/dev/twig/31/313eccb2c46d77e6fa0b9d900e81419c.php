...
class __TwigTemplate_506f431335f64376882b7e1ae2b54cd0 extends Template
{
...
<div class=\"container\">
    ...
    <div class=\"card\">
        ...
        yield ">Model</option>
            ...
            ";
        // line 523
        if ((($tmp = (isset($context["category"]) || array_key_exists("category", $context) ? $context["category"] : (function () { throw new RuntimeError('Variable "category" does not exist.', 523, $this->source); })())) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 524
        ...
        ";
        // line 535
        if ((($tmp =  !Twig\Extension\CoreExtension::testEmpty((isset($context["vehicles"]) || array_key_exists("vehicles", $context) ? $context["vehicles"] : (function () { throw new RuntimeError('Variable "vehicles" does not exist.', 535, $this->source); })()))) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 536
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["vehicle"]) {
                ...
                // line 558
                if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, $context["vehicle"], "isAvailable", [], "any", false, false, false, 558)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                ...
                yield "\">
                                        ";
                // line 559
                if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, $context["vehicle"], "isAvailable", [], "any", false, false, false, 559)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                    // line 560
...
{% endblock %}", "vehicle/index.html.twig", "C:\\Users\\skonb\\Desktop\\UrbanLink_Symfony-Production\\templates\\vehicle\\index.html.twig");
    }
}
