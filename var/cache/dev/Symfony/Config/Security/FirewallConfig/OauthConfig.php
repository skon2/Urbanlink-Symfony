...
class OauthConfig 
{
     ...
     * @default false
     * @param ParamConfigurator|bool $value
     * @deprecated Option "require_previous_session" at "oauth" is deprecated, it will be removed in version 7.0. Setting it has no effect anymore.
     * @return $this
     */
     ...
     * @return $this
     */
    public function resourceOwners(string $name, mixed $value): static
    {
