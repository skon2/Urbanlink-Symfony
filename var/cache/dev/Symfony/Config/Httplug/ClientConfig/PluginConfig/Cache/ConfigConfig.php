...
namespace Symfony\Config\Httplug\ClientConfig\PluginConfig\Cache;
...
class ConfigConfig 
{
     ...
     * @return $this
     */
    public function cacheKeyGenerator($value): static
    {
     ...
     * @return $this
     */
    public function blacklistedPaths(mixed $value): static
    {
     ...
     * @return $this
     */
    public function cacheListeners(mixed $value): static
    {
     ...
     * @return $this
     */
    public function respectResponseCacheDirectives(mixed $value): static
    {
