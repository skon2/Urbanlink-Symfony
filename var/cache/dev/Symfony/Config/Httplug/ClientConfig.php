...
class ClientConfig 
{
     ...
     * @return $this
     */
    public function flexibleClient($value): static
    {
     ...
     * @return $this
     */
    public function httpMethodsClient($value): static
    {
     ...
     * @return $this
     */
    public function batchClient($value): static
    {
     ...
     * @return $this
     */
    public function config(mixed $value = array (
    )): static
    {
     ...
     * @psalm-return (TValue is array ? \Symfony\Config\Httplug\ClientConfig\PluginConfig : static)
     */
    public function plugin(array $value = []): \Symfony\Config\Httplug\ClientConfig\PluginConfig|static
    {
    ...
    public function __construct(array $value = [])
    {
        ...
        if (array_key_exists('plugins', $value)) {
            $this->_usedProperties['plugins'] = true;
            $this->plugins = array_map(fn ($v) => \is_array($v) ? new \Symfony\Config\Httplug\ClientConfig\PluginConfig($v) : $v, $value['plugins']);
            unset($value['plugins']);
        }
    ...
    public function toArray(): array
    {
        ...
        if (isset($this->_usedProperties['plugins'])) {
            $output['plugins'] = array_map(fn ($v) => $v instanceof \Symfony\Config\Httplug\ClientConfig\PluginConfig ? $v->toArray() : $v, $this->plugins);
        }
